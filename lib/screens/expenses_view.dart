...
import '../services/expenses_analytics_service.dart';
...
String _formatPeso(int value) {
  final abs = value.abs();
  final s = _fmtCompact.format(abs);
  return value < 0 ? '-P$s' : 'P$s';
}

class ExpensesView extends StatefulWidget {
  const ExpensesView({super.key, this.branchId = '0'});

  /// Numeric string branch id; `0` = all branches.
...
class _ExpensesViewState extends State<ExpensesView> {
  ...
  Future<void> _load() async {
    ...
    final items = await ExpensesAnalyticsService.instance.fetchExpenseRankings(
    ...
    setState(() {
      _expenses = items;
      _loading = false;
      _error = items.isEmpty ? 'No expense data' : null;
    });
  }
  ...
  Widget build(BuildContext context) {
      ...
      content = Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Center(
              child: Text(_error ?? 'No expense data', style: TextStyle(fontSize: 15, color: Colors.grey[500])),
            ),
          ),
        ],
      );
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return SizedBox(height: MediaQuery.sizeOf(context).height, child: content);
      },
    );
  }
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              ...
              style: TextStyle(fontSize: labelSize, fontWeight: FontWeight.w600, color: Colors.white.withValues(alpha: 0.9)),
          ...
          children: [
                ...
                children: [
                  ...
                  if (item.rank > 3)
                    Positioned(
                      ...
                      child: Text(
                        '${item.rank}',
                        style: TextStyle(fontSize: isNarrow ? 10 : 12, fontWeight: FontWeight.bold, color: Colors.white),
                      ),
                    ),
                ],
              ),
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    item.name,
                    style: TextStyle(fontSize: isNarrow ? 14 : 16, fontWeight: FontWeight.bold, color: Colors.white),
                    maxLines: 1,
                  ...
                  Text(
                    item.categoryId,
                    style: TextStyle(fontSize: isNarrow ? 10 : 11, color: Colors.grey[500], fontWeight: FontWeight.w500),
                  ),
                ],
              ),
            ),
            SizedBox(
              ...
              child: Text(
                ...
                style: TextStyle(fontSize: isNarrow ? 12 : 14, fontWeight: FontWeight.bold, color: currentColor),
                textAlign: TextAlign.right,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
            ...
            SizedBox(
              ...
              child: Text(
                ...
                style: TextStyle(fontSize: isNarrow ? 12 : 14, fontWeight: FontWeight.w600, color: Colors.white),
                textAlign: TextAlign.right,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
